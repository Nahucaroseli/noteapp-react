...
<form onSubmit={(e) => { handleSubmit(e); }} className="h-auto w-96 bg-white text-gray-800 flex flex-col gap-y-5 items-center justify-center rounded-lg shadow-2xl p-6 relative">
    ...
    <h1 className="text-3xl font-bold mb-8 text-gray-700">Edit Note</h1>
    ...
    <button className="bg-black text-white px-6 py-2 rounded-lg font-semibold shadow-md transition duration-200">Edit</button>
</form>
</div>
)
}
